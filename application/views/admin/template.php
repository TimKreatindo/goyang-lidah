...
<head>
    ...
    <title><?= $title ?> - Goyang Lidah Admin</title>
...
<body>
            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="index.html" class="logo">
                        <img src="<?= base_url('template/admin') ?>/img/kaiadmin/logo_light.svg" alt="navbar brand" class="navbar-brand" height="20" />
                    </a>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        $main_menu = $this->app->get_menu('main', $id_role)->result();
                        foreach ($main_menu as $mm) {
                            if ($mm->type == 'main') {
                                echo '
                                        <li class="nav-item">
                                            <a href="' . base_url() . $mm->url . '" class="sidebar-link">
                                            ' . $mm->icon . '
                                            <span>' . $mm->menu . '</span>
                                            </a>
                                        </li>';
                            } else {
                                $sub_menu = $this->app->get_menu('sub', $id_role, $mm->id)->result();
                                $html_sub = '';
                                foreach ($sub_menu as $sm) {
                                    $html_sub .= '<li class="nav-item submenu  ">
                                                        <a href="' . base_url($sm->url) . '" >' . $sm->menu . '</a>
                                                    </li>';
                                }
                        ...
                        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#" aria-expanded="false">
                                    <div class="avatar-sm">
                                        <img src="<?= base_url('template/admin') ?>/img/profile.jpg" alt="..." class="avatar-img rounded-circle" />
                                    </div>
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg">
                                                    <img src="<?= base_url('template/admin') ?>/img/profile.jpg" alt="image profile" class="avatar-img rounded" />
                                                </div>
                                                <div class="u-text">
                                                    <h4>Hizrian</h4>
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item" href="#">Setting Toko</a>
                                            <div class="dropdown-divider"></div>
    ...
    <!-- Google Maps Plugin -->
    <script src="<?= base_url('template/admin') ?>/js/plugin/gmaps/gmaps.js"></script>
