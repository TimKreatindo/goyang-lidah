...
function add_form_mahasiswa(){
	const html = `<div class="row align-items-center">

                        <div class="col-10">
                            <input type="text" name="nim[]" class="form-control my-2" placeholder="NIM" required>
                            <input type="text" name="mahasiswa[]" class="form-control my-2" placeholder="Nama Mahasiswa" required>
                        </div>

                         <div class="col-2 text-center">
                            <button class="btn btn-danger btn-sm del-mahasiswa" type="button">
    ...
    $('#append-list-mahasiswa').append(html)
}

$(document).on('click', '.del-mahasiswa', function(){
	$(this).parent('div').parent('div').remove()
})